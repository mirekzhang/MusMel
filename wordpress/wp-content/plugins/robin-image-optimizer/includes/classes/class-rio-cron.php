...
class WRIO_Cron {
	...
	public function process() {
		...
		WIO_Logger::info( sprintf( "Start cron job. Scope: %s", $cron_running_page ) );
		...
		if ( is_wp_error( $result ) ) {
			WIO_Logger::info( sprintf( "Cron job failed. Error: %s", $result->get_error_message() ) );
		...
		WIO_Logger::info( sprintf( "End cron job. Scope: %s", $cron_running_page ) );
	}
