 ...
 * ```php
 * // Info message level
 * WIO_Logger::info('Some generic message, good to know');
 *
 * // Warning message level
 * WIO_Logger::warning('Something does not work or unusual');
 *
 * // Error message level
 * WIO_Logger::error('Something critical happened');
 *
 * // Debug message level
 * WIO_Logger::debug('Some message used for debug purposed. Could be stack trace.');
 * ```
 *
...
class WIO_Logger {
	...
	public function init() {
		...
		add_action( 'shutdown', [ 'WIO_Logger', 'flush' ], 9999, 0 );
	}
